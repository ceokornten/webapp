            ...
            <div class="navbar-default sidebar" role="navigation">
                <div class="sidebar-nav navbar-collapse">
                    <ul class="nav" id="side-menu">
                        ...
                        <li>
                            <a href="set_config.php"><i class="glyphicon glyphicon-cog fa-fw"></i> ตั้งค่าเว็บไซต์</a>
                        </li>
                        <li>
                            <a href="review.php"><i class="glyphicon glyphicon-star fa-fw"></i> รีวิวสินค้า</a>
                        </li>
                        <?php 
$sql="select count(Id_order) from tbl_order where Status_order='กำลังตรวจสอบ'";
