    ...
    <div id="wrapper">
        ...
        <div id="page-wrapper">
            ...
            <div class="modal fade" id="myModalschool" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                ...
                                <form action="add_review2.php" method="post" enctype="multipart/form-data">
...
<div class="table-responsive table-bordered">
                                <table class="table">
                                    ...
                                    <?php 
								$no=1;
								$sql_review="select * from tbl_review2 Order by No_review asc ";
								...
								while($rs_review=mysqli_fetch_array($result_review))
								{
									...
									?>
                                        <tr>
                                            <td>
                                          <form action="up_review2.php" method="post" enctype="multipart/form-data">
                                          <input type="hidden" value="<?=$Id_review?>" name="Id_review">
											...
											if($Img_review<>"")
											{
												?><a href="../imgreview2/<?=$Img_review?>" target="_blank"><img src="../imgreview2/<?=$Img_review?>?D=<?=time()?>" style="width:auto;height:100px"></a><?php
											}
											?>
                                            </td>
...
<button class="btn btn-success btn-xs dropdown-toggle" type="button" data-toggle="dropdown">อนุมัติ
  <span class="caret"></span></button>
    ...
    <li><a href="update_reviewstatus2.php?Id_review=<?=$Id_review?>&Status=Hidden">ไม่อนุมัติ</a></li>
                                                <?php
											}else
											{
												?>
<button class="btn btn-danger btn-xs dropdown-toggle" type="button" data-toggle="dropdown">ไม่อนุมัติ
  <span class="caret"></span></button>
     <ul class="dropdown-menu">
    <li><a href="update_reviewstatus2.php?Id_review=<?=$Id_review?>&Status=Show">อนุมัติ</a></li>
                                                <?php
											}
											?>
...
<a href="del_review2.php?Id_review=<?=$Id_review?>" onclick="return confirm('คุณแน่ใจที่จะลบข้อมูลนี้ ใช่หรือไม่')"><button class="btn btn-danger btn-xs">ลบ</button></a>

<!-- Mymodal school-->
            <div class="modal fade" id="myModaledit<?=$Id_review?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                <div class="modal-dialog">
                                <form action="edit_review2.php" method="post" enctype="multipart/form-data">
                                <input type="hidden" name="Id_review" value="<?=$Id_review?>">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
											...
											{
												?>
                                                <a href="del_imgreview2.php?Id_review=<?=$Id_review?>" onclick="return confirm('คุณแน่ใจที่จะลบข้อมูลนี้ ใช่หรือไม่')"><span class="btn btn-danger btn-xs" style="position:absolute;">Delete</span></a>
                                                <img src="../imgreview2/<?=$Img_review?>?D=<?=time()?>" class="img-thumbnail img-responsive" style="height:100px;">
												<?php
											}
											?>
                                            <input type="file" name="Img_review" class="form-control">
