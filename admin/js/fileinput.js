    ...
    FileInput.prototype = {
        ...
        _initTemplateDefaults: function () {
            ...
            tFooter = '<div class="file-thumbnail-footer">\n' +
			   ...
			   '        {caption}\nCover <input type="radio" value="{caption}" name="cover">\n' +
            ...
            tActions = '<div class="file-actions">\n' +
                ...
                '<div class="clearfix"></div>';
            //noinspection HtmlUnknownAttribute
            tActionDelete = '<a href="delete_img.php?img={data}"><button type="button" class="kv-file-remove {removeClass}" ' +
                'title="{removeTitle}" {dataUrl}{dataKey}>{removeIcon}</button></a>\n';
